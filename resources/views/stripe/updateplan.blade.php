      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <div class="card text-center mt-5">
            ...
            <a href="{{ route('upgrade-plan', $basic->plan_id) }}"  class="pricing-action l-amber">Choose plan</a>
          </div>
          @endif
        </div>
        @if ($professional)
        <div class="col-sm-4">
            <div class="card text-center  mt-5">
              ...
              <a href="{{ route('upgrade-plan', $professional->plan_id) }}" class="pricing-action l-amber" >Choose plan</a>
            </div>
          </div>
        @endif
        @if ($enterprise)
          <div class="col-sm-4">
            <div class="card text-center  mt-5">
              ...
              <a href="{{ route('upgrade-plan', $enterprise->plan_id) }}" class="pricing-action l-amber">Choose plan</a>
              </div>
          </div>
        @endif
    </div>
